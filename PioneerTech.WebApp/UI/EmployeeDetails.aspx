...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="Employee_Details" style="width: 569px; margin-right: 3px;">
...
<asp:RequiredFieldValidator ID="Last_NameRequiredFieldValidator" runat="server" ErrorMessage="Last Name is Required" ControlToValidate="Last_NameTextBox"></asp:RequiredFieldValidator>
        ...
        <tr id="EmailRow">
            ...
            <td style="width: 362px">
                ...
                <asp:RegularExpressionValidator ID="EmailRegularExpressionValidator" runat="server" ErrorMessage="Please Enter in Proper Email Format" ControlToValidate="EmailTextBox" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
        ...
        <tr id="Mobile_NumberRow">
            ...
            <td style="width: 362px">
                ...
                <asp:RegularExpressionValidator ID="Mobile_NumberRegularExpressionValidator" runat="server" ErrorMessage="Mobile Number must be in US Format" ControlToValidate="Mobile_NumberTextBox" ValidationExpression="((\(\d{3}\) ?)|(\d{3}-))?\d{3}-\d{4}"></asp:RegularExpressionValidator>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width: 362px"> <asp:Button ID="ClearButton" runat="server" OnClick="ClearButton_Click" Text="Clear"/></td>
